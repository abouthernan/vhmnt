...
<style is:global>
  .accordion__wrapper {
    border-top: 2px solid light-dark(#5b5a5a, #dddddd);
 ...
 @media screen and (max-width: 768px) {
  ...
  h3 {
    ...
    .accordion__title-icon {
    border: 2px solid red; /* Solo para ver si se está renderizando */
  }

  .accordion__title-icon svg {
    width: 16px !important; /* Asegura un tamaño adecuado en móviles */
    height: 16px !important;
  }

  .accordion__wrapper[open] .accordion__title-icon svg:last-of-type {
  transform: translateY(-50%) rotate(90deg) !important; /* Aplica rotación explícitamente */
  }
  ...
  .accordion__wrapper[open] {
    max-height: 500px; /* Ajusta el tamaño según el contenido */
  }
